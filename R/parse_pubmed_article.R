...
parse_pubmed_article <- function(pubmed_article) {
  ...
  out <- list(
    title = medline_citation %>% xml2::xml_find_all(".//ArticleTitle") %>% xml2::xml_text(),
    owner = medline_citation %>% xml2::xml_attr("Owner"),
    status = medline_citation %>% xml2::xml_attr("Status"),
    ...
    pmid2 = pubmed_data %>% xml2::xml_find_all("ArticleIdList/ArticleId[@IdType='pubmed']") %>% xml2::xml_integer(),
    doi = pubmed_data %>% xml2::xml_find_all("ArticleIdList/ArticleId[@IdType='doi']") %>% xml2::xml_text(),
    pmc = pubmed_data %>% xml2::xml_find_all("ArticleIdList/ArticleId[@IdType='pmc']") %>% xml2::xml_text(),

    journal_issn = medline_citation %>% xml2::xml_find_all(".//ISSN") %>% xml2::xml_text(),
    journal_issn_type = medline_citation %>% xml2::xml_find_all(".//ISSN") %>% xml2::xml_attr("IssnType"),
    pub_year = medline_citation %>% xml2::xml_find_all(".//PubDate/Year") %>% xml2::xml_integer(),
    pub_month = medline_citation %>% xml2::xml_find_all(".//PubDate/Month") %>% xml2::xml_text(),
    pub_day = medline_citation %>% xml2::xml_find_all(".//PubDate/Day") %>% xml2::xml_text(),
    epub_year = medline_citation %>% xml2::xml_find_all(".//ArticleDate/Year") %>% xml2::xml_integer(),
    epub_month = medline_citation %>% xml2::xml_find_all(".//ArticleDate/Month") %>% xml2::xml_text(),
    epub_day = medline_citation %>% xml2::xml_find_all(".//ArticleDate/Day") %>% xml2::xml_text(),
    pub_date_alt = medline_citation %>% xml2::xml_find_all(".//PubDate/MedlineDate") %>% xml2::xml_text(),
    journal_volume = medline_citation %>% xml2::xml_find_all(".//Volume") %>% xml2::xml_integer(),
    journal_issue = medline_citation %>% xml2::xml_find_all(".//Issue") %>% xml2::xml_integer(),
    journal_title = medline_citation %>% xml2::xml_find_all(".//Journal/Title") %>% xml2::xml_text(),
    journal_iso_abbr = medline_citation %>% xml2::xml_find_all(".//Journal/ISOAbbreviation") %>% xml2::xml_text(),
    journal_nlm_abbr = medline_citation %>% xml2::xml_find_all(".//MedlineJournalInfo/MedlineTA") %>% xml2::xml_text(),
    journal_nlm_id = medline_citation %>% xml2::xml_find_all(".//MedlineJournalInfo/NlmUniqueID") %>% xml2::xml_text(),

    #TODO:check whether could be multiple languages in separate xml
    lang = medline_citation %>% xml2::xml_find_all(".//Language") %>% xml2::xml_text()
  )
